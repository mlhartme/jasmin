...
import com.oneandone.jasmin.descriptor.Library;
import com.oneandone.jasmin.descriptor.Resource;
...
public class Repository {
    ...
    public void loadLibrary(Resolver resolver, Node base, Node descriptor, Node properties) throws IOException {
        ...
        for (com.oneandone.jasmin.descriptor.Module descriptorModule : library.modules()) {
